  ...
  return (
    <View className="flex-1 gap-6 px-5">
      <Input variant="tertiary">
        ...
        <Input.Field placeholder="O que você deseja ler hoje?" onChangeText={setSearch} />
      </Input>
        ...
        (search.length === 0 && (
          <View className="flex-row flex-wrap justify-center gap-4">
            {Object.values(genres).map((genre) => (
              <Pressable
                key={genre}
                className="h-28 w-1/3 flex-auto items-center justify-center rounded-lg bg-zinc-900"
                onPress={() => {
